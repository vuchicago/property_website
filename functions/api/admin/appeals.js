...
function buildAppealSelectList(columns) {
        return [
                ...
                appealColumn(columns, 'customer_first_name'),
                appealColumn(columns, 'customer_last_name'),
                appealColumn(columns, 'customer_phone'),
                appealColumn(columns, 'contract_name_confirmed_at'),
