...
const env = {
        ...
        CLOUDFLARE_DEEPSEEK_MODEL: process.env.CLOUDFLARE_DEEPSEEK_MODEL || 'deepseek/deepseek-v4-flash',
        CLOUDFLARE_DEEPSEEK_TURN_MODEL: process.env.CLOUDFLARE_DEEPSEEK_TURN_MODEL || 'deepseek/deepseek-v4-flash',
